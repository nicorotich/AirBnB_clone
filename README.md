...
This repository holds the console for an AirBnb clone site.
It is a back door for the adminitrator to manage the data and
everything else. Using this console a Database (either a file
database or a sql database) can be manipulated. The console
has been built with python and the cmd library.

## Files

The first Files contain the clases and 
they are found in the models directory as part of the module.
### Classes :cl:
...
* **Nicholas K. Rotich** [Nicholas](nikorotski@gmail.com)
* **Lameck M. Nyairo** [Lameck](#@gmail.com)
